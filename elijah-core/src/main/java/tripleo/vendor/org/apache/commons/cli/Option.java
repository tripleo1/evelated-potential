 ...
 * {@link Options}, its required flag cannot be changed.
 * </p>
 *
...
public class Option implements Cloneable, Serializable {
	...
	/**
	 * A nested builder class to create {@code Option} instances using descriptive
	 * methods.
	 * <p>
	 * Example usage:
	 * </p>
	...
	/**
	 * Add the value to this Option. If the number of arguments is greater than zero
	 * and there is enough space in the list then add the value. Otherwise, throw a
	 * runtime exception.
	 *
	...
	/**
	 * Clear the Option values. After a parse is complete, these are left with data
	...
	/**
	 * Gets the values of this Option as a String array or null if there are no
	 * values
	 *
	 ...
	 * to be parsed into individual tokens. When n-1 tokens have been processed and
	 * there are more value separators in the value, parsing is ceased and the
